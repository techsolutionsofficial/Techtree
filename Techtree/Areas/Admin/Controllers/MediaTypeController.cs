...
namespace Techtree.Areas.Admin.Controllers
{
    ...
    public class MediaTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ThumbnailImage")] MediaType mediaType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ThumbnailImage")] MediaType mediaType)
        {
            if (id != mediaType.Id)
            {
                return NotFound();
